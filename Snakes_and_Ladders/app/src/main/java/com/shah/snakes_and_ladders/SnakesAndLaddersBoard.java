...
public class SnakesAndLaddersBoard extends AppCompatActivity {
    ...
    public void diceRoll(View view){
        ...
        if(posP1 == 100 || posP2 == 100){
            Intent lastPage = new Intent(SnakesAndLaddersBoard.this,LastPageActivity.class);
    ...
    private void movePlayer1(int position,int positionOfPlayer1){
        ...
        if(position != posP2)
            DisplayBoard[i][j].setBackgroundResource(R.drawable.player1_1);
        else
            DisplayBoard[i][j].setBackgroundResource(R.drawable.players);
    ...
    private void movePlayer2(int position, int positionOfPlayer2){
        ...
        if(posP1!=position)
            DisplayBoard[i][j].setBackgroundResource(R.drawable.player2_1);
